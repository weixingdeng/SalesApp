...
@interface CPBSgmentScrollView : UIScrollView
@end
...
@property (nonatomic, strong) CPBSgmentScrollView *scrollView;

@end

@implementation CPBSgmentScrollView
...
- (id)initWithSectionTitles:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        self.type = CPBSegmentedControlTypeText;
    }
...
- (id)initWithSectionImages:(NSArray*)sectionImages sectionSelectedImages:(NSArray*)sectionSelectedImages {
    ...
    if (self) {
        ...
        self.type = CPBSegmentedControlTypeImages;
    }
...
- (instancetype)initWithSectionImages:(NSArray *)sectionImages sectionSelectedImages:(NSArray *)sectionSelectedImages titlesForSections:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        self.sectionSelectedImages = sectionSelectedImages;
        self.sectionTitles = sectiontitles;
        self.type = CPBSegmentedControlTypeTextImages;
    }
...
- (void)commonInit {
    self.scrollView = [[CPBSgmentScrollView alloc] init];
    ...
    self.selectionStyle = CPBSegmentedControlSelectionStyleTextWidthStripe;
    self.selectionIndicatorLocation = CPBSegmentedControlSelectionIndicatorLocationUp;
    self.segmentWidthStyle = CPBSegmentedControlSegmentWidthStyleFixed;
...
- (void)setSelectionIndicatorLocation:(CPBSegmentedControlSelectionIndicatorLocation)selectionIndicatorLocation {
    _selectionIndicatorLocation = selectionIndicatorLocation;
    
    if (selectionIndicatorLocation == CPBSegmentedControlSelectionIndicatorLocationNone) {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == CPBSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            CGFloat y = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight)/2 - stringHeight/2 + ((self.selectionIndicatorLocation == CPBSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
            
            CGRect rect;
            if (self.segmentWidthStyle == CPBSegmentedControlSegmentWidthStyleFixed) {
                rect = CGRectMake((self.segmentWidth * idx) + (self.segmentWidth - stringWidth)/2, y, stringWidth, stringHeight);
            } else if (self.segmentWidthStyle == CPBSegmentedControlSegmentWidthStyleDynamic) {
    ...
    } else if (self.type == CPBSegmentedControlTypeImages) {
        [self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            UIImage *icon = iconImage;
            CGFloat imageWidth = icon.size.width;
            CGFloat imageHeight = icon.size.height;
            CGFloat y = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight) / 2 - imageHeight / 2 + ((self.selectionIndicatorLocation == CPBSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
    ...
    } else if (self.type == CPBSegmentedControlTypeTextImages){
        [self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            ...
            CGFloat yOffset = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight) / 2 - stringHeight / 2 + ((self.selectionIndicatorLocation == CPBSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
    ...
    if (self.selectedSegmentIndex != CPBSegmentedControlNoSegment) {
        if (self.selectionStyle == CPBSegmentedControlSelectionStyleArrow) {
            ...
            if (!self.selectionIndicatorStripLayer.superlayer) {
                ...
                if (self.selectionStyle == CPBSegmentedControlSelectionStyleBox && !self.selectionIndicatorBoxLayer.superlayer) {
...
//    CGContextSetStrokeColorWithColor(context, [UIColor colorWithRGB:0xe5e5e5].CGColor);
//    CGContextSetLineWidth(context, (1.0f / [UIScreen mainScreen].scale));
//    CGSize contextSize = self.frame.size;
//    
//    CGContextMoveToPoint(context, 0, 1);
//    CGContextAddLineToPoint(context, contextSize.width, 1);
//    
...
- (void)setArrowFrame {
    ...
    if (self.selectionIndicatorLocation == CPBSegmentedControlSelectionIndicatorLocationDown) {
    ...
    if (self.selectionIndicatorLocation == CPBSegmentedControlSelectionIndicatorLocationUp) {
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionStyle == CPBSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == CPBSegmentedControlSelectionStyleTextWidthStripe &&
            sectionWidth <= self.segmentWidth &&
            self.segmentWidthStyle != CPBSegmentedControlSegmentWidthStyleDynamic) {
            CGFloat widthToEndOfSelectedSegment = (self.segmentWidth * self.selectedSegmentIndex) + self.segmentWidth;
            CGFloat widthToStartOfSelectedIndex = (self.segmentWidth * self.selectedSegmentIndex);
            
            CGFloat x = ((widthToEndOfSelectedSegment - widthToStartOfSelectedIndex) / 2) + (widthToStartOfSelectedIndex - sectionWidth / 2) - 15;
            return CGRectMake(x, indicatorYOffset, sectionWidth + 30, self.selectionIndicatorHeight);
        } else {
            if (self.segmentWidthStyle == CPBSegmentedControlSegmentWidthStyleDynamic) {
...
- (void)updateSegmentsRects {
    ...
    if (self.type == CPBSegmentedControlTypeText && self.segmentWidthStyle == CPBSegmentedControlSegmentWidthStyleFixed) {
    ...
    } else if (self.type == CPBSegmentedControlTypeText && self.segmentWidthStyle == CPBSegmentedControlSegmentWidthStyleDynamic) {
    ...
    } else if (self.type == CPBSegmentedControlTypeTextImages && CPBSegmentedControlSegmentWidthStyleFixed){
    ...
    } else if (self.type == CPBSegmentedControlTypeTextImages && CPBSegmentedControlSegmentWidthStyleDynamic) {
        NSMutableArray *mutableSegmentWidths = [NSMutableArray array];
...
- (void)setSelectedSegmentIndex:(NSUInteger)index animated:(BOOL)animated notify:(BOOL)notify {
    ...
    if (index == CPBSegmentedControlNoSegment) {
        ...
        if (animated) {
            ...
            if(self.selectionStyle == CPBSegmentedControlSelectionStyleArrow) {
                ...
                if ([self.selectionIndicatorStripLayer superlayer] == nil) {
                    ...
                    if (self.selectionStyle == CPBSegmentedControlSelectionStyleBox && [self.selectionIndicatorBoxLayer superlayer] == nil)
                        [self.scrollView.layer insertSublayer:self.selectionIndicatorBoxLayer atIndex:0];
